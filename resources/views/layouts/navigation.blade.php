                ...
                <a class="flex-1" href="{{ route('news') }}">
                    <div
                        ...
                        <svg class="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium text-transparent css-vubbuv" focusable="false"
                            ...
                            <path d="M15.7162 12.0369H8.4962" stroke="#9E9E9E" stroke-width="1.5" stroke-linecap="round"
                                  stroke-linejoin="round"></path>
                            <path d="M11.2513 7.86008H8.4963" stroke="#9E9E9E" stroke-width="1.5" stroke-linecap="round"
                                  stroke-linejoin="round"></path>
                        ...
                        <span class="whitespace-nowrap">Tin tức</span><span class="MuiTouchRipple-root css-w0pj6f"></span>
                    </div>
                </a>
            </div>
            <div class="col-2 d-md-inline mb-1">
            ...
            <div class="col-2 d-md-inline mb-1">
                <a class="flex-1" href="{{ route('account') }}">
                    <div
                        ...
                        <span class="whitespace-nowrap">Tài Khoản</span><span class="MuiTouchRipple-root css-w0pj6f"></span>
                    </div>
                </a>
            </div>
            <div class="col-2 d-md-inline mb-1">
                <div
                    ...
                    <span class="whitespace-nowrap">CSKH</span><span class="MuiTouchRipple-root css-w0pj6f"></span>
                </div>
            </div>
        </div>
    </div>
