...
<div class="">
    ...
    <div class="mt-3">
        <a href="/lucky-wheel">
            <div
                    class="MuiPaper-root MuiPaper-elevation MuiPaper-rounded MuiPaper-elevation1 h-[40px] flex items-center justify-between px-3 border-l-2 border-primary-dark cursor-pointer hover:bg-black/10 css-aoeo82">
                <div class="font-medium text-color-primary">Lucky Wheel</div>
                <svg
                        class="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium css-1h2no49" focusable="false"
                        aria-hidden="true"
                        viewBox="0 0 24 24" data-testid="KeyboardArrowRightOutlinedIcon">
    ...
    <div class="mt-3">
        <div
            ...
            <button
                    ...
                    tabindex="0"
                    type="button" aria-label="Xem chi tiết">
        ...
        <div class="modal-content css-mbdu2s">
            <div class="modal-body ">
                <button data-dismiss="modal"
                    ...
                    <svg class="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium css-vubbuv" focusable="false" style="fill: white !important;"
